---
title: "Using {azmetr} with {units}"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using {azmetr} with {units}}
...
That means it will also complain when you add something unitless (e.g. a regular numeric vector) to a vector with units
