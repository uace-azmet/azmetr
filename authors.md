...
- **Jeremy Weiss**. Author, maintainer, copyright holder.
  [](https://orcid.org/0000-0003-3597-0712)

- **Eric Scott**. Author. [](https://orcid.org/0000-0002-7430-7879)

## Citation

Source:
[`inst/CITATION`](https://github.com/uace-azmet/azmetr/blob/main/inst/CITATION)

Weiss J, Scott E (2025). *azmetr: Access Arizona weather data from the
AZMet API*.
...
package version 0.4.0, <https://github.com/uace-azmet/azmetr>.
    ...
    @Manual{,
      ...
      author = {Jeremy Weiss and Eric Scott},
      year = {2025},
...
Arizona Meteorological Network (2025). “Arizona Meteorological Network
(AZMet) Data.” Accessed 2025-11-20, <https://azmet.arizona.edu>.
