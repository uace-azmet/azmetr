...
daily <- az_daily()
#> Querying data from 2026-06-18
#> Returning data from 2026-06-18
hourly <- az_hourly()
...
#>           <dbl>             <dbl> <chr>           <chr>                    <dbl>
#> 1          13.8                 0 az01            Tucson                       1
#> 2          13.7                 0 az02            Yuma Valley                  1
#> 3          13.6                 0 az04            Safford                      1
#> 4          13.4                 0 az05            Coolidge                     1
#> 5          13.6                 0 az06            Maricopa                     1
#> 6          12.9                 0 az07            Aguila                       1
...
#> Querying data from 2026-06-11 through 2026-06-18
#> Returning data from 2026-06-11 through 2026-06-18

range(wk$datetime)
#> [1] "2026-06-11" "2026-06-18"
```
...
last_datetime
#> [1] "2026-06-19 09:00:00 MST"
last_48h <- last_datetime - hours(48)
hr <- az_hourly(start_date_time = last_48h)
#> Querying data from 2026-06-17 09:00 through 2026-06-19 09:00
#> Returning data from 2026-06-17 09:00 through 2026-06-19 09:00

range(hr$date_datetime)
#> [1] "2026-06-17 09:00:00 MST" "2026-06-19 09:00:00 MST"
```
