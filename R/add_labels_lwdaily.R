add_labels_lwdaily <- function(lwdaily) {
  ...
  attr(lwdaily$relative_humidity_30cm_max, "label") <- "Max. relative humidity at 30cm height (%)"
  attr(lwdaily$relative_humidity_30cm_mean, "label") <- "Avg. relative humidity at 30cm height (%)"
  attr(lwdaily$relative_humidity_30cm_min, "label") <- "Min. relative humidity at 30cm height (%)"
